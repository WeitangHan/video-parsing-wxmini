...
Component({
  ...
  methods: {
    ...
    showQrcode() {
      let that = this;
      var urlContent = app.globalData.url + "api/wx/showQRCode"
      request.requestPostApi(urlContent, {}, this, function (res) {
        if (res.status == 200) {
          wx.previewImage({
            urls: res.data,
          ...
          wx.previewImage({
            urls: ['https://img2.baidu.com/it/u=1390815689,3409386485&fm=253&fmt=auto&app=138&f=JPEG?w=400&h=400'],
            current: 'https://img2.baidu.com/it/u=1390815689,3409386485&fm=253&fmt=auto&app=138&f=JPEG?w=400&h=400' // 当前显示图片的http链接      
          })
        }
      }, function (res) {
        console.error(res)
